/* Clean data in SQL Queries - Nashville Housing*/
...
/* Populate Property Address Data*/
	/* Where PropertyAddress is NULL, populate with PropertyAddress from 1st result  */
SELECT * 
FROM PortfolioProject1.dbo.NashvilleHousing
...
ALTER TABLE PortfolioProject1.dbo.NashvilleHousing
ALTER COLUMN SaleDateConverted nvarchar(255)